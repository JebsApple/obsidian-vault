...
- `MiNegocio-backend/` → trabajo migrado a `proyecto/minegocio-backend`
...
### Base de datos (`proyecto/minegocio-database`)
...
- Eliminar `proyecto/minegocio-backend-old/` (dueño deployequipo6, requiere sudo)
